...
Here are answers to some common questions concerning Scribe. When faced with an issue, please refer to this document whenever possible. Note that some of these question concern Scribe's use throughout an organization.  
...
Certainly! We offer a comprehensive trial for Scribe, giving you the opportunity to experience its full range of features.  
During the trial, you can convert source files of your choice and download any of the many accessible formatted documents that Scribe generates, just as you would with a paid account.  
To get started, you have two options:
* Use our web interface to upload your source document directly to Scribe.
* Embed the custom HTML code (available on request) directly into your website.

The great news is that your trial has no set time limit. We’re confident that you’ll recognize the value of Scribe once you give it a try.  
Initially, you can use the free Scribe trial for up to 100 pages of information after full registration. If you require a higher page limit, please don’t hesitate to reach out to us, and we can accommodate your needs. However, given the simplicity of Scribe, the basic trial often provides an adequate testbed for most users.  
If you’re interested in starting a free trial, simply [click here](https://scribeit.io/) or call us at 612-246-4818. We’re here to assist you in exploring the benefits of Scribe firsthand.

### What features are available with the trial?

With our free trial of Scribe, you gain access to every feature that Scribe offers.  
During the trial, you can input any file type that Scribe accepts, and you have the freedom to download one or all the accessible document formats to assess how effectively Scribe processes your documents. However, it’s important to note that we do place a limitation on the trial, restricting it to 100 scans or pages. This allows you to explore the full capabilities of Scribe while maintaining a manageable scope for the trial period.
[Click here to give Scribe a try!](https://scribeit.io/)

### How long is the trial period?

The trial period for Scribe is not constrained by a fixed number of days. Instead, you have the freedom to utilize the full-featured version of Scribe until you’ve processed 100 pages of information.  
Should you require an extension beyond the page limit, we will consider such requests on a case-by-case basis. This approach enables you to input a diverse array of document types and formats into Scribe, giving you the opportunity to witness how effectively it generates accessible documents in the various file formats we support.

### What happens when our trial time is over?

When your trial period with Scribe ends, the system will notify you when you’ve reached your page limit. An email notification will be sent to the administrator of the account, informing them that the trial has ended.  
After experiencing the cost-saving capabilities of Scribe’s Augmented Document Remediation technology, we would be delighted to assist you in converting your account from trial status to one of our active plans. You can choose from our three comprehensive options that align with your organization’s specific needs. We’re here to ensure a seamless transition that best serves your requirements.
...
1. Once your account is activated, you can upload individual documents from your computer or a URL to the Scribe. We can also supply you with a few lines of HTML code you can actually embed in to your website for automation.
...
Certainly, Scribe is versatile and can handle various document types such as invoices, statements, reports, and account summaries. Here’s how it works:
* Scribe empowers you with the ability to create document profiles tailored to different document types. This feature enhances both speed and accuracy in producing accessible documents.
* Let’s take the example of invoices. If your organization regularly produces invoices with a unique format using non-standard industry software, you can create a customized invoice template within Scribe.
* When a user clicks on the Scribe link to receive an accessible copy of an invoice, Scribe processes it using the parameters within the invoice template. This ensures that your users consistently receive beautifully formatted invoices every time.

So, whether it’s invoices, statements, reports, or other document types, Scribe can adapt to your specific needs and produce accessible documents with precision.

### How do profiles work?

Profiles in Scribe are a powerful feature that allows you to create templates for specific document types. Here’s how profiles work:
* Templates: Profiles function as templates that define the structure and formatting of a particular document type, such as invoices or reports.
* Identifying Documents: When a document is processed through Scribe, the system quickly analyzes it to identify its type and formatting.
* Matching Templates: If a matching profile/template is found, Scribe uses the parameters defined in that profile to process the document. This means that Scribe doesn’t have to analyze the document as intensely because it already knows how it should be formatted.
* Speed and Consistency: Using profiles speeds up the processing of documents and ensures that they are consistently converted into accessible formats based on the predefined template.

In essence, profiles allow you to streamline the conversion process for specific document types, making it faster and more accurate.
