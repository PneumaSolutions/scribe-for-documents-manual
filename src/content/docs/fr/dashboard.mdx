...
Scribe dispose d'un panneau de configuration pour faciliter les différents ajustements de remédiation des documents, ainsi que d'une page d'organisation pour gérer les membres de votre organisation.
