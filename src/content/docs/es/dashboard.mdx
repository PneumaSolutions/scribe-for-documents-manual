...
Scribe cuenta con un panel de configuración para facilitar diversos ajustes de corrección de documentos, así como una página de organización para gestionar los miembros de su organización.

### Valores predeterminados de los documentos 

La página de valores predeterminados del documento, situada en el menú Configuración, le permite establecer valores predeterminados globales que persisten en todas las correcciones. Entre ellos se incluyen:
* Preferencia de descripción automática de imágenes
* Conmutación de procesamiento de contenido matemático
* Idioma
* Preferencias de texto a voz (se recordarán en todos los idiomas)
    * Género (se muestra cuando el idioma está en Automático)
    * Dialecto
