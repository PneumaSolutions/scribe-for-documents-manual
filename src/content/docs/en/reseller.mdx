...
If your organization is set up as a reseller, you will see a Reseller Dashboard in the navigation menu of your account's landing page. This dashboard will allow you to manage the child organizations under your organization's management.  
...
Once you've added at least one child organization, you will see a "Customer Organizations" section with a table of organizations under your umbrella. Each organization contains the following attributes:
* The title of the organization, presented as a link to its management page
* A status column (See below for information on organization status)
* Remaining credits
* Converted pages
* Trial status ( if any)
* A button to archive or unarchive the organization (Activate the "Show archived" checkbox in the filter controls to reveal archived organizations)

### Organization Page

Clicking on an organization's link presents you with the organization's page, allowing you to perform various managerial tasks for the specific organization.

#### Editing an Organization

Clicking the "Edit organization details" link will allow you to edit the organization's name, as well as its domain.

#### Modifying an Organization's Status

A Customer Status dropdown is offered in order to easily categorize and filter organizations according to their level of onboarding. Each organization's status is initially unset, allowing you to determine their status throughout the various stages. Available statuses include:
* Prospect
* Trial
    * Note that selecting this status does not actually initiate a trial for the organization
* Customer
* Churned

As mentioned above, the Customer Status column is designed to facilitate filtering and record-keeping. As such, it does not change based on actions performed on an organization, nor does choosing a status perform any actions on an organization.
