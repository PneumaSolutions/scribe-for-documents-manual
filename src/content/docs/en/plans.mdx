...
Pages can be purchased a la carte at a per-page fixed rate. 200 is the minimum amount of pages that can be purchased via this method. The per-page rate, as well as the minimum purchase price, is determined by the local currency. Pages purchased in this way will never expire.
