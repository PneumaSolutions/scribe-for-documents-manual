...
Scribe verfügt über ein Einstellungsfeld zur Erleichterung verschiedener Anpassungen bei der Dokumentenwiederherstellung sowie über eine Organisationsseite zur Verwaltung der Mitglieder Ihrer Organisation.

### Dokument-Standards 

Auf der Seite Dokumentvorgaben, die sich im Menü Einstellungen befindet, können Sie globale Vorgaben festlegen, die für alle Korrekturen gelten. Dazu gehören:
* Automatische Bildbeschreibungspräferenz
* Umschalten zwischen mathematischer Inhaltsverarbeitung
* Sprache
* Voreinstellungen für Text in Sprache (diese werden für alle Sprachen gespeichert)
    * Geschlecht (wird angezeigt, wenn die Sprache auf Automatisch eingestellt ist)
    * Dialekt
    * Standardstimme (eine Beispieltaste ist vorhanden)
